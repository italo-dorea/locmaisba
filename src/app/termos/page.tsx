      ...
      <div className="bg-gray-50 p-8 rounded-lg border border-gray-200">
        <Typography>
          ...
          <Paragraph className="text-gray-600 text-base">
            Se você tiver dúvidas sobre esta Política de Privacidade, sobre os dados que mantemos sobre você ou se desejar exercer seus direitos de proteção de dados, por favor não hesite em nos contatar através do e-mail: <Text strong>comercial@locmaisba.com.br</Text>.
          </Paragraph>
        </Typography>
      </div>
